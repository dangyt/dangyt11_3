...
@property (nonatomic, strong) NSArray<HateModel *> *hate;
@property (nonatomic, strong) BraumModel *Braum_E;
...
@property (nonatomic, strong) NSArray<LikeModel *> *like;
